...
export function Footer() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-0 h-[360px] w-[620px] -translate-x-1/2 rounded-full bg-primary/[0.03] blur-[110px] max-sm:h-[240px] max-sm:w-[420px] max-sm:blur-[80px]"
      />
          ...
          <div className="space-y-6">
            ...
            >
              <img
                ...
                alt="Zyvoris"
                draggable={false}
                className="h-8 w-auto transition-all duration-300 group-hover:scale-[1.03] group-hover:opacity-95"
              ...
              <ul className="space-y-4">
                {navigationLinks.map((item) => (
                  <li key={item.label}>
                    <Link
                      href={item.href}
                      className="group inline-flex items-center rounded-sm text-sm text-white/50 transition-all duration-300 hover:translate-x-1 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                      style={{ transitionTimingFunction: EASE }}
                    >
                      <span>{item.label}</span>

                      <ArrowRight
                        className="ml-1.5 h-3.5 w-3.5 -translate-x-1 opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-70"
                        style={{ transitionTimingFunction: EASE }}
                        aria-hidden="true"
                      />
                    </Link>
          ...
          <div className="space-y-7">
            <div>
              ...
              <a
                ...
                className="group inline-flex max-w-full items-center gap-3 rounded-xl text-sm text-white/55 transition-colors duration-300 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
              >
                <span
                  className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] transition-all duration-300 group-hover:border-primary/25 group-hover:bg-primary/[0.08]"
                  style={{ transitionTimingFunction: EASE }}
                >
                  <Mail
                    className="h-4 w-4 text-white/50 transition-colors duration-300 group-hover:text-primary"
                    style={{ transitionTimingFunction: EASE }}
                    aria-hidden="true"
                  />
                </span>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="group flex h-11 w-11 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] transition-all duration-300 hover:-translate-y-1 hover:border-primary/25 hover:bg-primary/[0.08] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                style={{ transitionTimingFunction: EASE }}
              >
                <Instagram
                  className="h-[18px] w-[18px] text-white/45 transition-colors duration-300 group-hover:text-primary"
                  style={{ transitionTimingFunction: EASE }}
                  aria-hidden="true"
                />
              </a>
